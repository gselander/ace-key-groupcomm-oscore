...
At this point in time, the joining node might not have all the necessary information concerning public keys for computing/verifying countersignatures in the  OSCORE group. In such a case, the joining node MAY use the 'sign_info' and 'pub_key_enc' parameters defined in Section 3.3 of {{I-D.ietf-ace-key-groupcomm}}.
...
The payload of the 2.01 (Created) response is a CBOR map, which MUST include the 'cnonce' parameter defined in section 5.1.2 of {{I-D.ietf-ace-oauth-authz}}, and MAY include the 'sign_info' parameter as well as the 'pub_key_enc' parameter defined.
...
* 'sign_alg' takes values from Tables 5 and 6 of {{RFC8152}}.
...
* 'pub_key_enc' with value as specified in {{fig-pub-key-enc-values}}.
